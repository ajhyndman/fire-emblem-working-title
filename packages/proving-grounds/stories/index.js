...
storiesOf('RaritySelector', module).add('default', () => {
  const RaritySelectorStory = withState(
    'selected',
    'setSelected',
    4,
...
storiesOf('SegmentedControl', module).add('default', () => {
  const SegmentedControlStory = withState(
    'selected',
    'setSelected',
    0,
  )(({ selected, setSelected }) => (
...
storiesOf('StatSheet', module).add('Anna: default', () => (
  <div style={{ background: colors.elephant, padding: 30 }}>
    <StatSheet heroInstance={heroInstance} level={40} rarity={5} />
  </div>
));
