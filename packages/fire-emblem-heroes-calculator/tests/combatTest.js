...
// TODO: Rewrite these without hardcoded valiues
...
//   if (
//     result.combatInfo.attackerHp !== expectedHp1 ||
...
//   simulateCombat(
//     t,
//     withHpMissing(10, desperationNino),
//     makeHero('Hector'),
//     33 - 10,
//     0,
//   );
...
// test('Vantage', t => {
//   t.plan(4);
//   const deathBlowCordelia = makeHero('Cordelia', 5, {
//     PASSIVE_A: 'Death Blow 3',
//   });
...
//     t,
//     deathBlowCordelia,
//     withHpMissing(10, vantageTakumi),
//     0,
//     40 - 10,
//   );
// });
...
//     simulateCombat(
//       t,
//       withSpecial('Draconic Aura', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 12,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Dragon Fang', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 20,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Bonfire', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 18,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Ignis', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 29,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Iceberg', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 11,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Glacies', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 17,
//     );
...
//     simulateCombat(
//       t,
//       withSpecial('Moonbow', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 11,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Luna', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 18,
//     );
...
//     simulateCombat(
//       t,
//       withSpecial('Aether', makeHero('Beruka')),
//       makeHero('Beruka'),
//       46 - 3,
//       46 - 3 - 18,
//     );
...
//     simulateCombat(
//       t,
//       withSpecial('Glimmer', makeHero('Odin')),
//       makeHero('Odin'),
//       43 - 10,
//       43 - 15,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Night Sky', makeHero('Odin')),
//       makeHero('Odin'),
//       43 - 10,
//       43 - 15,
//     );
//     simulateCombat(
//       t,
//       withSpecial('Astra', makeHero('Odin')),
//       makeHero('Odin'),
//       43 - 10,
//       43 - 25,
//     );
...
//       t,
//       makeHero('Odin'),
//       withSpecial('Noontime', makeHero('Odin')),
//       43 - 10,
//       43 - 10 + 3,
//     );
//     simulateCombat(
//       t,
//       makeHero('Odin'),
//       withSpecial('Daylight', makeHero('Odin')),
//       43 - 10,
//       43 - 10 + 3,
//     );
...
//       t,
//       makeHero('Odin'),
//       withSpecial('Aether', makeHero('Odin')),
//       43 - 22,
//       43,
//     );
//     t.end();
...
//       t,
//       makeHero('Takumi'),
//       withSpecial('Miracle', makeHero('Est')),
//       40,
//       1,
//     );
...
//       t,
//       makeHero('Klein'),
//       withSpecial('Miracle', makeHero('Subaki')),
//       40,
//       1,
//     );
//     t.end();
...
//     const bladePalla = withSkill(
//       'Heavy Blade 3',
//       withSkill('Bonfire', makeHero('Palla')),
//     );
...
//     const bladePalla = withSkill(
//       'Heavy Blade 3',
//       withSkill('Moonbow', makeHero('Palla')),
//     );
//     const slowGuardDraug = {
//       ...withSkill('Guard 3', makeHero('Draug')),
//       bane: 'spd',
//     };
...
//     const buffedNino = withBuff(
//       'def',
//       2,
//       withBuff('spd', 4, withBuff('atk', 4, nino)),
//     );
