...
const unitList: Array<Hero> = [
  {
    ...
    assets: {
      portrait: {
        '75px':
          'https://proving-grounds-static.ajhyndman.com/75px-Icon_Portrait_Robin (F).png',
        '113px':
          'https://proving-grounds-static.ajhyndman.com/113px-Icon_Portrait_Robin (F).png',
        '150px':
          'https://proving-grounds-static.ajhyndman.com/150px-Icon_Portrait_Robin (F).png',
      },
    },
    stats: {
      '1': {
